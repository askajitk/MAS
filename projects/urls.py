...
urlpatterns = [
    ...
    path('<int:project_pk>/team/<int:member_pk>/delete/', views.team_member_delete, name='team_member_delete'),
    path('<int:project_pk>/vendors/add/', views.vendor_add, name='vendor_add'),
    path('<int:project_pk>/vendors/<int:vendor_pk>/delete/', views.vendor_delete, name='vendor_delete'),
